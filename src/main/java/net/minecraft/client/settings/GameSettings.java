...
public class GameSettings
{
    ...
    public static enum Options
    {
        ...
        FULLSCREEN_MODE("of.options.FULLSCREEN_MODE", true, false, 0.0F, getDisplayModesLength(), 1.0F),
        ...
        private static float getDisplayModesLength() 
        {
            try {
                return (float)Config.getDisplayModes().length;
            } catch (Exception e) {
                return 1.0F;
            }
        }
