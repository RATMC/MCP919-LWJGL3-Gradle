...
public class Config
{
    ...
    {
        if (p_getDisplayMode_0_ == null || p_getDisplayMode_0_.length <= 0)
        {
            return null;
        }
        ...
        {
            DisplayMode[] adisplaymode = (DisplayMode[])p_getDisplayMode_0_.clone();
            Arrays.sort(adisplaymode, new DisplayModeComparator());
            return adisplaymode[adisplaymode.length - 1];
        }
    }
